...
export const CRITERIA: Criterion[] = [
  { id: "salary-total", title: "總年薪", description: "月薪、年終、績效獎金、分紅等合計", weight: 5, note: "" },
  ...
  { id: "dividend-potential", title: "分紅潛力(若有)", description: "部門、單位獲利、個人績效", weight: 3, note: "不把傳聞當保證" },
